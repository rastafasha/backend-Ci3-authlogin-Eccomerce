...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2018 at 07:57 AM
...
INSERT INTO `blogs` (`id`, `title`, `user_id`, `category_id`, `description`, `video_review`, `image`, `is_featured`, `is_active`, `created_at`) VALUES
...
INSERT INTO `users` (`user_id`, `username`, `password`, `first_name`, `last_name`, `email`, `role`, `token`, `is_active`, `created_at`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', NULL, 'admin@admin.com', 'ADMIN', 'a1aed1a77c0916c43a4a67afe49af265', 1, '2018-10-27 05:25:13');
